...
/*int main()
{
	std::cout << "\nOMP: \n";
	{
        ...
        double end_time1 = omp_get_wtime();//start time
		double start_time1 = omp_get_wtime();//start time
		...
		std::cout << "\nSeconds: " << end_time1 - start_time; //total time
		std::cout << "\nSeconds: " << end_time - start_time1; //total time
		}
	//}
	//system("pause");
	return 0;
